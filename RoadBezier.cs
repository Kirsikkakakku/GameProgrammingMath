        ...
        for (int slice = 0; slice <= Slices; slice++)
        {
            ...
            */
            ...
            for (int i = 0; i < Roadshape.vertices.Length; i++)
            {
                ...
                Vector3 transformed_point = op.localToWorld(roadpoint * RoadScaler);
                vertices.Add(transformed_point);

                Vector3 transformed_point_next = op.localToWorld(roadpoint_next * RoadScaler);

                Vector3 transformed_point_following = op_next.localToWorld(roadpoint * RoadScaler);
